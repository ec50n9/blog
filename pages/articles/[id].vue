...
<template>
  <div p="x-5 y-5" bg="slate-50 @dark:slate-9" font="sans" view-transition-name="article-bg">
    <!-- 封面 -->
    <img block object-cover rd-xl style="box-shadow: rgba(0, 0, 0, 0.1) 0px 4px 12px;" :src="article.cover"
    ...
    <!-- 内容 -->
    <article m="t-5" p="b-5" text-base prose prose-slate xl="text-xl" view-transition-name="article-content"
